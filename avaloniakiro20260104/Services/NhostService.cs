...
public static class NhostService
{
    ...
    public static async Task<bool> TestConnectionAsync(string subdomain, string adminSecret)
    {
        try
        {
            ...
            var url = $"https://{subdomain}.nhost.run/v1/graphql";
    ...
    public static string GetGraphQLEndpoint(string subdomain)
    {
        return $"https://{subdomain}.nhost.run/v1/graphql";
    }

    public static string GetAuthEndpoint(string subdomain)
    {
        return $"https://{subdomain}.nhost.run/v1/auth";
    }
